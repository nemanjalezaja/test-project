<template>
  <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="15px" viewBox="0 0 47 47" xml:space="preserve">
    <g>
      <g id="Layer_1_27_">
        <g>
...
export default {
  ...
  computed: {
    fill() {
      if (this.liked) return 'rgba(79, 70, 229, 1)';
      return 'none';
    },
  },
};
